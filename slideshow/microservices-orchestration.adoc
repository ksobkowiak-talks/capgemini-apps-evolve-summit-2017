...
image::turbo-camel.jpg[align="center"]
...
image::docker-logo.png[align="center"]
...
|===
^.^| image:netflix-java-logo.png[width="70%"]
a|
.^a|
...
image::non-java-languages.png[align="center", width="50%"]
